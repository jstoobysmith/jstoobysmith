...
RevealHighlight().hljs.registerLanguage("lean", function(hljs) {
    var LEAN_KEYWORDS = {
      $pattern: /#?\w+|λ|∀|Π|∃|:=?/u,
      keyword:
        'theorem|10 lemma|10 definition def class structure instance abbrev ' +
        `informal_lemma informal_definition semiformal_result ` +
      ...
      built_in:
        ...
        'congr congr_n congr_arg norm_num ',
      literal:
        'tt ff',
      meta:
        'noncomputable|10 private protected meta mutual #check',
      section:
        'section namespace',
      sorry:
        'sorry admit',
    ...
    var LEAN_DEFINITION = {
      className: 'theorem',
      beginKeywords: 'def theorem lemma class instance structure abbrev',
      end: /:=/,
      excludeEnd: true,
      contains: [
        {
