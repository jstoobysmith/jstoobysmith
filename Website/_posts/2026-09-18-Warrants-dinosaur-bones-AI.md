---
layout: post
title:  "Warrants, dinosaur bones, and resolving conjectures with AI"
date:   2026-09-18
type: card-img-top
categories:
caption:
...
I've recently been taking part in a conversation on the Lean Zulip about what to do when a conjecture is resolved using AI and a proof assistant (in this case Lean). The conversation can be found [here](https://leanprover.zulipchat.com/#narrow/channel/113488-general/topic/Proving.20an.20open.20conjecture.20with.20AI.20.2B.20Lean/near/624336071). This is my take and conclusion from the discussion there, and is an extension of one of my posts. I frame this as an open letter to anyone who finds themselves having resolved a conjecture with very little human input using AI and a proof assistant.
