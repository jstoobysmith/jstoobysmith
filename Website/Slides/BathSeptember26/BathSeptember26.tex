...
\begin{frame}[plain]
  \vfill
  \begin{center}
    {\color{plsky}\footnotesize\bfseries UNIVERSITY OF BATH \;\textbullet\; SEPTEMBER 2026}
  ...
  \begin{columns}[T,onlytextwidth]
    ...
    \begin{column}{0.475\textwidth}
      \begin{plcardh}{plorange}{\plchip{plorange}{SEP 2026}}{2.80cm}
        ...
        \par\vspace{4pt}
        {\normalsize\normalfont\color{plink}Disproved.}
        \par\vfill
        {\footnotesize\normalfont\color{plmuted}OpenAI, internal model}
      \end{plcardh}
    \end{column}
...
\end{lstlisting}
      ...
      \begin{minipage}[c]{1.9cm}
        \href{https://live.lean-lang.org/}%
          {\includegraphics[width=1.9cm]{LeanExampleQR.pdf}}
      \end{minipage}%
      \hfill
      \begin{minipage}[c]{\dimexpr\linewidth-2.1cm\relax}
        {\footnotesize\color{white!85}\faIcon{globe}\;
          \href{https://live.lean-lang.org/}%
            {\color{white!85}Open the live editor}}\par
        \vspace{2pt}
        {\tiny\color{white!70}scan to open on your phone}
      \end{minipage}
    \end{column}
...
\begin{frame}{What the loop is built on}
  ...
  \begin{tcolorbox}[enhanced, width=0.92\textwidth, arc=10pt, outer arc=10pt,
    ...
    \begin{minipage}[c]{0.70\textwidth}
      ...
      {\small\color{plmuted}\raggedright A \emph{monolithic} library of
    ...
    % footnotesize (not \small as on the Physlib card): five longer stats,
    % and the row has to stay on one line.
...
\begin{frame}{Structure of Physlib}
  \vfill
  \begin{center}
    {\footnotesize\color{plsky!70!white}\bfseries UPSTREAM}\quad
    {\color{white}\bfseries Mathlib}\\[2pt]
    {\color{plsky!60!white}\Large$\Downarrow$}\\[4pt]
    {\footnotesize\color{plsky!70!white}\bfseries THIS REPOSITORY}
  \end{center}
  ...
  \begin{center}
    {\footnotesize\color{plsky!70!white}\bfseries ADJACENT}\quad
    {\color{plsky!60!white}\Large$\Rightarrow$}\quad
...
\begin{frame}[fragile]{Interesting results in Physlib}
  ...
  \begin{columns}[T,onlytextwidth]
    ...
    \begin{column}{0.475\textwidth}
      \begin{itemize}
        \item[{\color{plgreen}\faIcon{check-circle}}] Classical harmonic oscillator
        \item[{\color{plgreen}\faIcon{check-circle}}] Quantum harmonic oscillator
        \item[{\color{plgreen}\faIcon{check-circle}}] Maxwell's equation
        \item[{\color{plgreen}\faIcon{check-circle}}] Lorentz group
        \item[{\color{plgreen}\faIcon{check-circle}}] Twin paradox
      \end{itemize}
    \end{column}

    \begin{column}{0.475\textwidth}
      \begin{itemize}
        \item[{\color{plgreen}\faIcon{check-circle}}] Tight binding chain
        \item[{\color{plgreen}\faIcon{check-circle}}] Anomaly cancellation
        \item[{\color{plgreen}\faIcon{check-circle}}] CKM matrix
        \item[{\color{plgreen}\faIcon{check-circle}}] Wick's theorem
        \item[{\color{plgreen}\faIcon{check-circle}}] String theoretic
      \end{itemize}
    \end{column}
  ...
  \begin{center}
    {\footnotesize\color{white!85}\faIcon{globe}\;
      \href{https://live.lean-lang.org/\#url=https\%3A\%2F\%2Fgithub.com\%2Fjstoobysmith\%2FJTSphyslib\%2Fblob\%2FHiggsExample\%2FPhyslib\%2FParticles\%2FStandardModel\%2FHiggsBoson\%2FExample.lean}%
        {\color{white!85}Example of Higgs result}}
  \end{center}
  \vfill
  \setbeamercolor{normal text}{fg=plink}
  \usebeamercolor*{normal text}
...
\begin{frame}{Other work on Lean at Bath}
  ...
  \begin{tcolorbox}[enhanced, width=0.85\textwidth, arc=10pt, outer arc=10pt,
    ...
    {\normalsize\color{plink}\raggedright A library for partially automating the extraction of
    ...
    {\small\color{plmuted}Thomas Powell \;\textbullet\; Ben Langton}
  \end{tcolorbox}
  \end{center}
  \vfill
\end{frame}
