...
\begin{frame}[fragile]{There is a problem!}
  ...
  \begin{columns}[c,onlytextwidth]
    ...
    \begin{column}{0.415\textwidth}
      \begin{plcard}[top=7pt,bottom=7pt]{plember}{The catch 1}
      ...
      \begin{plcard}[top=7pt,bottom=7pt,before skip=2pt]{plblue}{The catch 2}
        {\plbody We don't want AI constantly \textbf{reproducing}
         things in \textbf{inefficient} ways.\par}
      \end{plcard}
    \end{column}
